          ...
          <select id="comunidad" class="browser-default col s10" required>
            ...
            require('../php/conexion.php');
                ...
                while($comunidad = mysqli_fetch_array($sql)){
                  ?>
                  <option value="<?php echo $comunidad['id_comunidad'];?>"><?php echo $comunidad['nombre'].', '.$comunidad['municipio'].' (*Pregago: $'. $comunidad['instalacion'].', *Contrato: $'.$comunidad['contrato'].')';?></option>
                  <?php
                } 
            ?>
          </select>
