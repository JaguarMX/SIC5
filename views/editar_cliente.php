...
<script>
  function showContent() {
    ...
    if (document.getElementById('IntyTel').checked==true || document.getElementById('Telefonia').checked==true) {
  ...
  function update_cliente() {
      ...
      if (document.getElementById('IntyTel').checked==true) {
        ...
        var textoPT = $("select#paquete_t").val();
...
if (isset($_POST['no_cliente']) == false) {
  ...
  <body onload="javascript:showContent()">
    <div class="container"><br>
      <h3 class="hide-on-med-and-down">Editar cliente No. <?php echo $cliente['id_cliente'];?></h3>
      <h5 class="hide-on-large-only">Editar cliente No. <?php echo $cliente['id_cliente']; ?></h5><br><br>
      <div id="resultado_update_cliente"></div>
      <div class="row">
        <form class="col s12">
          ...
          <div class="row">
            ...
            <div class="col s12 m6 l6">
              ...
              <div class="row">
                ...
                <div class="col s12 m4 l4">
                  <p><br>
                    <input type="checkbox" <?php echo $ch3;?> id="Telefonia" onchange="javascript:showContent()"/>
              ...
              <?php 
                $FCORTE = (in_array($_SESSION['user_id'], array(10, 49)))? '': 'disabled';
                $pq = $cliente['paquete_t'];  
              ?>
              <div class="input-field">
              ...
              <div class="row">
                ...
                <div class="input-fiel col s12 m6 l6" id="content2" style="display: none;">
                  <label><i class="material-icons">import_export</i>Paquete tefefonia:</label>
                  <select id="paquete_t" class="browser-default" required>
