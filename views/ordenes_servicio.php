...
<div class="container">
  ...
  if (($area['area']=="Administrador" AND (in_array($id_user, array(10, 70, 49, 88, 83, 91))))  OR $area['area'] == 'Redes' OR $id_user == 25 OR $id_user == 28) {
  ...
  if (($area['area']=="Administrador" AND (in_array($id_user, array(10, 70, 49, 88, 83, 91))))  OR $area['area'] == 'Taller') {
    #SI SI PERTENECE MOSTRAR TODAS LAS ORDENES SEPARADAS POR DEPARTAMENTO
  ?>
    <div class="row">
  ...
  if (($area['area']=="Administrador" AND (in_array($id_user, array(10, 70, 49, 88, 83)))) OR (in_array($id_user, array(59, 66, 90, 91, 84)))) {
    #SI SI PERTENECE MOSTRAR TODAS LAS ORDENES SEPARADAS POR DEPARTAMENTO
  ?>
    <div class="row">
