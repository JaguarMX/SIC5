	...
	<div class="container">
		...
		<div class="row">
		      ...
		      <div class="input-field col s12 m4 l4">
		        ...
		        <input type="text" id="ip" data-length="30" value="<?php echo $servidor['ip']; ?>">
		        <label for="ip">IP o dirección del Servidor:</label>
		      </div>
		      <div class="input-field col s12 m4 l4">
		        <i class="material-icons prefix">settings_ethernet</i>
		        <input type="text" id="ip_local" data-length="30" value="<?php echo $servidor['ip_local']; ?>">
		      ...
		      <div class="input-field col s12 m3 l3">
		        <i class="material-icons prefix">settings_input_hdmi</i>
		        <input type="number" id="port_web" data-length="6" value="<?php echo $servidor['port_web']; ?>">
