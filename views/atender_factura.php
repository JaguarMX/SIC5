   		...
   		<ul class="collection">
            <li class="collection-item avatar">
              ...
              <p><b>Nombre: </b><?php echo $datos['nombre'];?><br>
                ...
                <b>Cotizacion: </b> $<?php echo $orden['precio'];?><br> <b>Documento: </b><a href = "../files/cotizaciones/<?php echo $orden['cotizacion_n'];?>" target = "blank"><?php echo $orden['cotizacion_n'];?></a> 
                  <?php
                  $totalE = 0;
