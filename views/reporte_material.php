        ...
        <div class="row">
            ...
            <div class="input-field col s12 l3 m3">
                <select id="usuario" class="browser-default">
                  ...
                  <?php 
                  $sql_usuario = mysqli_query($conn,"SELECT * FROM users WHERE (area != 'Cobrador' AND area != 'Oficina' AND user_id != 10 AND user_id != 56 AND user_id != 61 AND user_id != 62  AND user_id != 54) AND estatus = 1");
