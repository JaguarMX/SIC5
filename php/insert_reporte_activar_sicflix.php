<html>
  ...
  $Estaus = 0;
  //CONDICION PARA ASIGNAR EL PRECIO DE LOS PAQUETES
  if($Paquete == 'Premium'){
    $PrecioPaquete = 100;
  }else{
    $PrecioPaquete = 60;
  ...
  $sql = "INSERT INTO `reporte_sicflix` (cliente, descripcion, estatus, paquete, precio_paquete, fecha_registro, registro) VALUES ($IdCliente, '$Descripcion',$Estaus, '$Paquete', $PrecioPaquete, '$Fecha', $id_user)";
