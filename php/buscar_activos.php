...
<div class="row">
  ...
  <div class="col s12 m6 l6">
    <h4 class="hide-on-med-and-down indigo-text"><b>INACTIVOS: (<?php echo $Total_Inactivos.'/'.$Total_Clientes; ?> = <?php echo (($Total_Inactivos*100)/$Total_Clientes); ?>%)</b></h4>  
    <h5 class="hide-on-large-only indigo-text"><b>INACTIVOS: (<?php echo $Total_Inactivos.'/'.$Total_Clientes; ?> = <?php echo (($Total_Inactivos*100)/$Total_Clientes); ?>%)</b></h5>
    <table class="border highlight">
      <thead>
        <tr>
        <th>No.</th>
